...
create a configuration file for frps `./conf/frp/frps.ini`, and fill it with:
...
- if you didn't see a config item named `API URL`, you should probably fill in the `API IP` and `API Port`
