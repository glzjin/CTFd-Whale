...
$(".delete-container").click(function(e) {
    ...
    CTFd.ui.ezq.ezQuery({
        ...
        body: body,
        success: function() {
            CTFd.fetch("/api/v1/plugins/ctfd-whale/admin/container?user_id=" + user_id, {
                    method: "DELETE",
...
$(".renew-container").click(function(e) {
    ...
    CTFd.ui.ezq.ezQuery({
        ...
        body: body,
        success: function() {
            CTFd.fetch("/api/v1/plugins/ctfd-whale/admin/container?user_id=" + user_id + "&challenge_id=" + challenge_id, {
                    method: "PATCH",
                    credentials: "same-origin",
                    headers: {
                        Accept: "application/json",
